                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-5">
                                        ...
                                        <form action="update/<?= $barang['barang_id']; ?>" method="post"
                                            ...
                                            <label for="tentang" class="box">Detail Produk:</label>
<br>
<textarea id="tentang" name="tentang" style="width: 100%; max-width: 800 ; padding: 10px; height: 400px; overflow: auto; word-wrap: break-word;" required>
    <?= htmlspecialchars($barang['tentang']); ?>
</textarea>
<hr>
                                            ...
                                            <hr>
                                            <p>Gambar produk lama</p>
                                            <img src="<?= base_url('uploads/foto/' . $barang['foto']); ?>" alt="Foto Lama" style="max-width: 100px;">
                                            <hr>
