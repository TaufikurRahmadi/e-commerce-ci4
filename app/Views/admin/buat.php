                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        ...
                                        <form action="update/<?= $barang['barang_id']; ?>" method="post"
                                            ...
                                            <label for="tentang">Detail Produk:</label>
                                            <textarea style="width: 100%; max-width: 800 ; padding: 10px; height: 400px; overflow: auto; word-wrap: break-word;" type="text" name="tentang" value="<?= $barang['tentang']; ?>"
                                                required>
                                                </textarea>
                                            ...
                                            <img src="<?= base_url('uploads/foto/' . $barang['foto']); ?>"
                                                alt="Foto Lama" style="max-width: 100px;">
